    ...
    <div className="flex flex-col h-full">
      ...
      <div className="px-4 py-4 border-b border-gray-200">
        <div className="flex items-center justify-between">
          <h2 className="text-base font-semibold text-gray-700">Messages</h2>
          <Link
            href="/messages"
          ...
          <div className="w-full space-y-2">
            ...
            >
              ...
              <div>
                ...
                <p className="text-xs text-gray-400">Find items and contact sellers</p>
              </div>
            </Link>
            <Link
              href="/sell"
            ...
            >
              ...
              <div>
                ...
                <p className="text-xs text-gray-400">Sell your items to other students</p>
              </div>
            </Link>
          </div>
        </div>
