  ...
  return (
    <main className="bg-surface">
      <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
        ...
        <div className="space-y-6 rounded-2xl border border-border-default bg-surface p-6 shadow-sm sm:p-8">
          {children}
        </div>
        ...
        <div className="mt-8 text-sm text-secondary">
          <p>
            ...
            <Link href="/help" className="font-medium text-primary underline underline-offset-4">
              Help Center
            </Link>
            {' '}or{' '}
            <Link
...
export function Section({
  ...
  return (
    <section className="space-y-3">
      ...
      <div className="space-y-3 text-sm leading-7 text-secondary">{children}</div>
    </section>
  )
}
