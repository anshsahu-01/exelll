      ...
      <div className="bg-surface rounded-xl border border-border-default p-6 flex flex-col gap-4">
        ...
        {!hideContact && (
          <button
            ...
            disabled={isLoading}
            className="cursor-pointer mt-2 w-full flex items-center justify-center gap-2 px-4 py-2.5 border border-border-default rounded-lg text-sm font-medium text-secondary hover:bg-surface-hover transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
          >
