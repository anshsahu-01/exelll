  ...
  return (
    ...
    >
      ...
      <Section heading="Direct Buyer-Seller Transactions">
        <p>
          If a buyer and seller complete a transaction directly outside Just Sell’s verification
      ...
      <Section heading="Platform-Assisted Verified Transactions">
        <p>
          When a transaction is completed through Just Sell’s verification-assisted purchase flow,
          a platform service fee or commission of 10% applies to the assisted workflow.
        </p>
        <p>
          In these verified transactions, Just Sell may assist with product condition review,
