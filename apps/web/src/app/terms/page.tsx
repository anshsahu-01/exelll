  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="prose prose-blue max-w-none text-gray-600">
        <h2 className="mt-8 text-xl font-bold text-gray-900">1. Acceptance of Terms</h2>
        ...
        <h2 className="mt-8 text-xl font-bold text-gray-900">3. User Conduct</h2>
        ...
        <h2 className="mt-8 text-xl font-bold text-gray-900">4. Right to Remove Content</h2>
