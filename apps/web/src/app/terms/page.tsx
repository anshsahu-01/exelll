  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="prose prose-blue max-w-none text-secondary">
        ...
        <p>By accessing and using Exelll, you agree to be bound by these Terms of Service. If you do not agree, please do not use our platform.</p>
        ...
        <p>You agree to use Exelll respectfully and lawfully. Any abusive, fraudulent, or illegal activity will result in immediate account termination.</p>

        <h2 className="mt-8 text-xl font-bold text-primary">4. Right to Remove Content</h2>
        <p>Exelll reserves the right to remove any listings or ban any accounts at our sole discretion, without prior notice, if they violate our policies or are deemed inappropriate.</p>
