  ...
  return (
    <SafeAreaView className="flex-1 bg-white">
      ...
      <ScrollView contentContainerClassName="p-5 pb-10">
        ...
        <Text className="text-sm text-muted">By accessing and using Exell, you agree to be bound by these Terms of Service. If you do not agree, please do not use our platform.</Text>
        ...
        <Text className="text-sm text-muted">You agree to use Exell respectfully and lawfully. Any abusive, fraudulent, or illegal activity will result in immediate account termination.</Text>

        <Text className="mb-2 mt-4 text-lg font-bold text-ink">4. Right to Remove Content</Text>
        <Text className="text-sm text-muted">Exell reserves the right to remove any listings or ban any accounts at our sole discretion, without prior notice, if they violate our policies or are deemed inappropriate.</Text>
      </ScrollView>
    </SafeAreaView>
  );
}
